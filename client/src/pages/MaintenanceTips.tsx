      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Section 1: Seasonal & Safety Essentials */}
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              ...
              <div className="bg-blue-50 p-6 rounded-lg mb-6">
                <h3 className="text-xl font-semibold mb-4 text-primary">Snow Load Management</h3>
                <ul className="space-y-2 text-gray-700">
                  <li className="flex items-start">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-blue-600">Air Leak Management</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Seal around recessed lights and fans
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Check attic access hatches for proper sealing
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Insulate and seal around chimneys
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Use weatherstripping around penetrations
                    </li>
                  </ul>
                </div>
              </div>
            ...
            {/* Section 3: Year-Round Maintenance */}
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <div className="flex items-center mb-6">
              ...
              <div className="bg-gray-50 p-6 rounded-lg mb-6">
                <h3 className="text-xl font-semibold mb-4 text-green-600">Regular Inspections</h3>
                <div className="grid md:grid-cols-3 gap-4">
                  <div>
                    <h4 className="font-semibold mb-2">Monthly Tasks</h4>
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• Check for obvious damage</li>
                      <li>• Look for interior leaks</li>
                      <li>• Clear minor debris</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Seasonal Tasks</h4>
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• Inspect metal components</li>
                      <li>• Check attic ventilation</li>
                      <li>• Test drainage systems</li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Annual Tasks</h4>
                    <ul className="text-sm text-gray-700 space-y-1">
                      <li>• Re-seal penetrations</li>
            ...
            {/* Section 4: Drainage & Flat Roof Care */}
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <div className="flex items-center mb-6">
                <i className="fas fa-tint text-3xl text-blue-400 mr-4"></i>
                <h2 className="text-3xl font-bold text-gray-800">Drainage & Flat Roof Care</h2>
              </div>
              
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-blue-500">Low-Slope Roof Maintenance</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                    ...
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Check membrane seams and joints
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Clean drains and scuppers regularly
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-blue-500">Drainage Solutions</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Address ponding areas within 48 hours
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                    ...
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Install crickets for better water flow
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Maintain proper roof slope
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="text-center">
                <Link href="/contact">
                  <button className="bg-blue-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 transition-colors">
                    Worried About Ice Dams? Get Answers
                  </button>
                </Link>
              </div>
            </div>

            {/* Section 5: Materials & Upgrades */}
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
              <div className="flex items-center mb-6">
                <i className="fas fa-hammer text-3xl text-orange-500 mr-4"></i>
                <h2 className="text-3xl font-bold text-gray-800">Durable Materials & Long-Term Upgrades</h2>
              </div>
              
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-orange-500">Material Assessment</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Inspect for UV damage on shingles
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Check thermal expansion cracks
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Assess flashing condition regularly
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Monitor granule loss patterns
                    </li>
                  </ul>
                </div>
                <div>
                  <h3 className="text-xl font-semibold mb-4 text-orange-500">Smart Upgrades</h3>
                  <ul className="space-y-2 text-gray-700">
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                    ...
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Upgrade drip edge during reroof
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
                      Plan replacement at 20-25 years
                    </li>
                    <li className="flex items-start">
                      <i className="fas fa-check text-green-500 mt-1 mr-2"></i>
              ...
              <div className="text-center">
                <Link href="/contact">
                  <button className="bg-orange-500 text-white px-8 py-3 rounded-lg font-semibold hover:bg-orange-600 transition-colors">
                    Protect Your Roof from Hail—Request a Quote
                  </button>
                </Link>
              </div>
            </div>
